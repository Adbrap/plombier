...
# ----- fonction Principale -----#
def Finder_IETE(time1, time_name1, start, end, start2, TETE):
    global ticker
    global antholemuscler
    global compteurjson
    # while True:
...
for data in databax:
    ...
    for tempss in minute:
        for date in liste_date :
            Finder_IETE(tempss,"minute",f'2023-{date}','2023-10-03',f'2023-{date}',TETE)
